...
class TransactionCommandTest {
    ...
    @Test
    void transactionCommandShouldReturnPaymentsPage() throws InvalidCardException, UserNotFoundException,
            UserCardNotFoundException, PaymentCreateException, TransactionException {
